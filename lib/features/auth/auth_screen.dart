                  ...
                  : Column(
                      ...
                      children: [
                        FilledButton(
                          ...
                          child: Text(_isSignUp ? 'Sign Up' : 'Login', style: const TextStyle(fontSize: 18)),
                        ),
                        ...
                        OutlinedButton.icon(
                          ...
                          icon: const Icon(Icons.g_mobiledata, size: 32), // Using a generic icon if brand icon not available
